...
fun.version <- "b7785839035" # fun.version refers to the current commit for data_processing_functions.r
```

```{r on_aciss_nontexts}
par_function_args <- list(dataframe=df_WL, 
                          N.types=NULL, 
                          N.utts=NULL, 
                          by.size=FALSE, 
                          dict=dict, 
...
aciss_function(fun.version, id="WL_nontexts", starts=1:20, iter=50, par_function_args) # 20 starts and 50 iter gives 1000 samples for each nontext
showStatus(makeRegistry(id = "WL_nontexts"))
```
