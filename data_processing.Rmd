...
write.table(df.hj.con, file="contexts_HJ_con.txt", quote=F, col.names=T, row.names=F, append=F, sep="\t")
# df.hj.con <- read.table("contexts_HJ_con.txt", header=1, sep="\t", stringsAsFactors=F, quote="", comment.char ="") 
```
