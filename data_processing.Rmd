...
fun.version <- "fcb165771d6fe00d" # fun.version refers to the current commit for data_processing_functions.r
```
...
# 20 starts and 100 iter gives 2000 samples for each nontext (takes about 60min per 1000 samples)
...
# killJobs(makeRegistry(id = "nontexts_WL_freq"),findRunning(makeRegistry(id = "nontexts_WL_freq")))
# killJobs(makeRegistry(id = "nontexts_HJ_freq"),findRunning(makeRegistry(id = "nontexts_HJ_freq")))
# killJobs(makeRegistry(id = "nontexts_LDA_freq"),findRunning(makeRegistry(id = "nontexts_LDA_freq")))
# killJobs(makeRegistry(id = "nontexts_STM_freq"),findRunning(makeRegistry(id = "nontexts_STM_freq")))
...
cutoffs <- seq(from=.6, to=.95, by=.01)
...
ggsave("plots/swingley_fig1a_global.png")
...
ggplot(fig1b.data, aes(x=cutoff, y=n, group=N.syl, color=as.factor(N.syl))) +
  geom_line()
ggsave("plots/swingley_fig1b_global.png")
...
tests.contexts.TTR <- test_context_vs_nontext(context_all, nontext_results, outcome="TTR")
