...
df <- left_join(df, temp.codes, by="orth") # join temp.codes back to full df
...
fun.version <- "a84aa0d616281d80" # fun.version refers to the current commit for data_processing_functions.r
```
...
context_all <- left_join(context_all, select(context_detail_summary, method.short, context, most.freq.syl))
```
