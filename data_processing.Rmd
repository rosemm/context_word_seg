...
```{r aciss_first_time_only, eval=FALSE}
...
fun.version <- "1307938ce49" # fun.version refers to the current commit for data_processing_functions.r
```
...
# 20 starts and 50 iter gives 1000 samples for each nontext
par_function_args[[1]] <- df_WL
aciss_function(fun.version, id="nontexts_WL", starts=1:20, iter=50, par_function_args) 

par_function_args[[1]] <- df_STM
aciss_function(fun.version, id="nontexts_STM", starts=1:20, iter=50, par_function_args) 

par_function_args[[1]] <- df_HJ
aciss_function(fun.version, id="nontexts_HJ", starts=1:20, iter=50, par_function_args)

par_function_args[[1]] <- df_LDA
aciss_function(fun.version, id="nontexts_LDA", starts=1:20, iter=50, par_function_args)
