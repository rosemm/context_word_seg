clean_contexts <- function(doc, key_file="context_cleaning_keys.txt", interactive=TRUE ){
  ...
  new_codes(raw_codes, cols=c("context_raw", "context_clean"), key_file, interactive)
