...
plot_context_vs_nontext_oldversion <- function(context, nontext, global, outcome, Z.score=FALSE, methods.to.use=c("WL", "LDA", "STM", "HJ"), annotate=NULL, xlabs=FALSE, save.to, ...){
