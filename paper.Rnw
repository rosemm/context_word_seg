...
@lecture{Fausey2015,
  ...
  title = {{The changing rhythms of life: Activity cycles in the first two years of everyday experience}},
  year = {2015},
  address = {Philadelphia, PA},
  howpublished= {Paper presented at the 2015 biennial meeting of the Society for Research in Child Development},
  month={March}
}
@book{Box1987,
...
For this analysis, our approach was to use a list of key words that we expected would be associated with particular contexts – for example, milk was on the list for mealtime words, and wipe was on the list for diaper change words. 
