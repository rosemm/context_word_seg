...
\label{app:KeyWords}
{\renewcommand{\arraystretch}{.6} % this changes the vertical spacing in the table below (http://tex.stackexchange.com/questions/50332/vertical-spacing-of-a-table-cell)
